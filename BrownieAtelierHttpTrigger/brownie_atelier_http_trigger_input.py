...
class BrownieAtelierHttpTriggerInput(BaseModel):
    ...
    '''
    target_container: str = Field(default=settings.TARGET_CONTAINER__AUTO, title="対象コンテナー")
    container_controll_command: str = Field(default=settings.CONTAINER_CONTROLL__STOP, title="コンテナーコントロールコマンド")
