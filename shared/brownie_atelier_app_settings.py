...
container_app__env_vars = [
    ...
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__SMTP_HOST',
                        secure_value=settings.CONTAINER_APP__NOTICE__SMTP_HOST),
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__SMTP_PORT',
                        secure_value=settings.CONTAINER_APP__NOTICE__SMTP_PORT),
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__FROM_EMAIL',
                        secure_value=settings.CONTAINER_APP__NOTICE__FROM_EMAIL),
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__TO_EMAIL',
                        secure_value=settings.CONTAINER_APP__NOTICE__TO_EMAIL),
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__PASSWORD',
                        secure_value=settings.CONTAINER_APP__NOTICE__PASSWORD),
    EnvironmentVariable(name='BROWNIE_ATELIER_NOTICE__TIMEOUT_LIMIT',
    ...
    EnvironmentVariable(name='PREFECT__WORK_POOL',
